...
//           <span className="text-gray-800 font-medium">3</span> {/* Replace with dynamic value */}
//         </div>
//         <div className="flex justify-between mb-2">
//           <span className="text-gray-600">Total Price:</span>
//           <span className="text-gray-800 font-medium">₦15,000</span> {/* Replace with dynamic value */}
//         </div>
