...
function MyCourseTop() {
  return (
    ...
    <div className="flex flex-col gap-4 items-start justify-center relative">
        ...
        <div className="flex flex-col gap-4 lg:flex-row items-center justify-between shrink-0 w-[96%] relative px-2 mx-auto">
            <div className="bg-white rounded-lg border-solid border-grey-600 border pr-1 flex flex-row items-center justify-between shrink-0 w-[300px] relative">
                <input type='search' placeholder='Search...' className="pl-2 ml-1 text-left font-small-text-font-family text-small-text-font-size leading-small-text-line-height font-small-text-font-weight relative py-3 w-[90%]" />
            ...
            <div className="flex flex-row gap-6 items-center justify-end shrink-0 relative">
                <div className="flex flex-row gap-[15px] items-center justify-start shrink-0 relative">
                    ...
                    <select className="bg-white rounded-lg border-solid border-grey-900 border pt-2.5 pr-2 md:pr-6 pb-2.5 pl-2 md:pl-6 flex flex-row gap-1.5 items-center justify-center shrink-0 relative">
                ...
                <div className="bg-white rounded-lg border-solid border-grey-900 border pt-1.5 pr-2 md:pr-6 pb-1.5 pl-2 md:pl-6 flex flex-row gap-1.5 items-center justify-center shrink-0 relative">
